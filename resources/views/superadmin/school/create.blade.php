                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <div class="d-flex align-items-start align-items-sm-center gap-4">
                                                <img src="{{ asset('assets/default/placeholder.png') }}" alt="user-avatar"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="contact_number" id="contact_number"
                                                class="form-control phone-mask @error('contact_number') is-invalid @enderror"  value="{{ old('contact_number') }}">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="landline_number" id="landline_number"
                                                class="form-control phone-mask @error('landline_number') is-invalid @enderror" value="{{ old('landline_number') }}">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="affilliation_number" class="form-control @error('affilliation_number') is-invalid @enderror"
                                                id="affilliation_number" value="{{ old('affilliation_number') }}">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="board" class="form-control @error('board') is-invalid @enderror" id="board" value="{{ old('board') }}">
                                            @error('board')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="type" class="form-control @error('type') is-invalid @enderror" id="type" value="{{ old('type') }}">
                                                <option value="secondary" @if(old('type') == 'secondary') selected @endif>Secondary</option>
                                                <option value="higher_secondary" @if(old('type') == 'higher_secondary') selected @endif>Higher Secondary</option>
                                            </select>
                                            @error('school_type')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="medium" class="form-control @error('medium') is-invalid @enderror" id="medium">
                                                <option value="english" @if(old('medium') == 'english') selected @endif>English</option>
                                                <option value="bhutness" @if(old('medium') == 'bhutness') selected @endif>Bhutness</option>
                                                <option value="both" @if(old('medium') == 'both') selected @endif>Both</option>
                                            </select>
                                            @error('medium')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
