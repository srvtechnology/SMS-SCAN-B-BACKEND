...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="my-3">
                        <div class="card mb-4">
                            <div class="card-body">
                                <form id="myForm" action="{{ route('school.designations.store') }}" method="POST">
                                    @csrf
                                    @error('Designation.*')
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="field1">Designation Name 1:</label>
    ...
    <script>
        ...
        function createField() {
          ...
          var label = $('<label>', { for: 'designation' + fieldCount, text: 'Designation Name ' + fieldCount + ':' });

          var inputGroup = $('<div>', { class: 'input-group' });

          var input = $('<input>', { type: 'text', class: 'form-control Designation', id: 'designation' + fieldCount, name: 'designation[]'});
        ...
        $('#myForm').submit(function(event) {
            ...
            $('#fieldContainer input').each(function(index) {
                ...
                if (fieldValue === '') {
                    errorMessages.push('Designation Name ' + fieldIndex + ' is required.');
                }
            });
