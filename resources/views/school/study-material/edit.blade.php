            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="my-3">
                        <div class="card mb-4">
                            <div class="card-body">
                                <form id="myForm" action="{{ route("school.studyMaterial.update-content") }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="id" value="{{ $study_material->id }}">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="field1">Title:</label>
                                                <input type="text" class="form-control @error('title') is-invalid @enderror" id="title"
                                                    name="title" value="{{ old('title',$study_material->title) }}">
                                            </div>
                                            @error('title')
                                        ...
                                        <div class="col-md-6 mb-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('type') is-invalid @enderror" id="type"
                                                    name="type" value="{{ old('type',$study_material->type) }}">
                                            </div>
                                            @error('type')
                                                <div class="text-danger">
                                                    {{ $message }}
                                        ...
                                        <div class="col-md-6 mb-2">
                                            <div class="form-group">
                                                ...
                                                <select name="class_id" id="class_id" class="form-control @error('class_id') is-invalid @enderror">
                                                    ...
                                                    <option value="{{ $class->id }}" @if($study_material->class_id == $class->id) selected @endif>{{ $class->name }}</option>
                                                    @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="" cols="30" rows="6">{{ $study_material->description }}</textarea>
                                            </div>
                                            @error('description')
                                                <div class="text-danger">
                                                    {{ $message }}
